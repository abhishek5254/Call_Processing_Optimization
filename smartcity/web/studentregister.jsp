                ...
                <div class="col-sm-12 parent" id="parent" style="min-height: 700px;">
                    <div class="row">
                        ...
                        <div class="col-sm-12 text-center text-capitalize" style="min-height: 50px;" >
                            <span style="font-size:30px;font-family: Arial Rounded MT;"><u>Register as Student</u></span>
                        </div>
                        <div class="col-sm-12" style="min-height:600px;">
                            ...
                            <div class="col-sm-5" style="min-height:600px;margin: 50px;">
                                <br/>
                                <form class="form-horizontal"  action="generalcode/sturegcode.jsp"  method="post">
                                    <label>Name</label>
