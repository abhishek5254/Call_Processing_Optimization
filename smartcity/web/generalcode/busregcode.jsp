...
<%
    ...
    String query1="insert into busregister values('"+name+"','"+date+"','"+gender+"','"+email+"','"+password+"','"+mobile+"','"+address+"','"+regdate+"')";
    String query2="insert into buslogin values('"+email+"','"+password+"','"+usertype+"')";
