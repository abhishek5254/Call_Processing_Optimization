      ...
      <ul class="nav navbar-nav navbar-right"style="font-size: 18px;">
        ...
        <li><a href="logout.jsp">Logout</a></li>
                ...
                <div class="col-sm-12 parent">
                    <div class="col-sm-12 text-center" style="min-height: 50px;margin-top: 5px;"><span style="color:green; font-size: 25px;font-family: Arial Rounded MT;"> All Enquiries</span></div>
