      ...
      <ul class="nav navbar-nav navbar-right"style="font-size: 18px;">
        ...
        <li><a href="logout.jsp">Logout</a></li>
                ...
                <div class="col-sm-12 parent">
                    <div class="col-sm-12 text-center" style="min-height: 100px;padding-top: 40px;"><span style="color: green;font-size: 30px;font-family: Arial Rounded MT"> Change Password</span></div>
                    <div class="col-sm-4"></div>
                    <div class="col-sm-4">
                        <form class="form-horizontal" action="usercode/changepasswordcode.jsp" method="post">
