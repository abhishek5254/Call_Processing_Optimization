      ...
      <ul class="nav navbar-nav navbar-right"style="font-size: 18px;">
        ...
        <li><a href="logout.jsp">Logout</a></li>
              ...
              <div class="col-sm-12 text-center" style="min-height: 50px;">
                  ...
                  <hr style="width: 200px;border: 2px solid green;border-radius: 2px;;margin-top: -1px;"/>
                </div>
                    <div class="col-sm-3" style="min-height: 200px;"></div>
                    <div class="col-sm-6" style="min-height: 200px;">
                        <form class="form-horizontal" action="usercode/questioncode.jsp" method="post" >
                            <label>Enter Question:</label>
                            <textarea  name="questiontext" class="form-control"   placeholder="Enter your question" rows="3" required style="resize: none;"></textarea>
                            <br/>
                    ...
                    <div class="col-sm-6">
                        <span style="color: green;font-size: 25px;">Questions</span>
        ...
        <tr>
            ...
            <td><a href="postanswer.jsp?qid=<%=rs.getString("qid")%>">Post Answer</a>
            <td><a href="viewanswer.jsp?qid=<%=rs.getString("qid")%>">View Answer</a>
        </tr>
        <% } %>
                        </table>
                    </div>
