        ...
        <li><a href="logout.jsp">Logout</a></li>
                ...
                <div class="col-sm-12 parent">
                  ...
                  <hr style="width: 200px;border: 2px solid;margin-top: -1px;"/>
                    ...
                    <div class="col-sm-6">
                        <form class="form-horizontal" action="usercode/answercode.jsp" method="post" >
                            <label>Enter Answer:</label>
                            <textarea name="answertext" placeholder="Enter your answer" class="form-control" required></textarea>
                            <br/>
                            <label>
                            <%
                            ...
                            <input type="hidden"  name="qid" value="<%=qid%>"   class="form-control"/>
                            <br/>
