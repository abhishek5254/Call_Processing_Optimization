    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right"style="font-size: 18px;">
        ...
        <li><a href="logout.jsp">Logout</a></li>
                ...
                <div class="col-sm-12 parent" style="min-height: 350px;">
                    <div class="col-sm-12 text-center" style="min-height: 50px;">
                        <span style="color: green;font-size: 28px;">Search Solution</span>
                    </div>
                    <div class="col-sm-3"></div>
                    <div class="col-sm-6">
                        <form class="form-horizontal" action="search.jsp" method="post">
                            <br/>
                            <label>Enter Problem Id or Problem Text:</label>
                            <textarea class="form-control" name="search" placeholder="Enter Problem Id or Problem Text" rows="3" style="resize: none;"></textarea>
                            <br/>
