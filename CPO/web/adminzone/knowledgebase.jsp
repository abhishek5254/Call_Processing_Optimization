    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      <ul class="nav navbar-nav navbar-right"style="font-size: 18px;">
        ...
        <li><a href="logout.jsp"><i class="fa fa-tag"></i>Logout</a></li>
                ...
                <div class="col-sm-12 parent" style="min-height: 700px;">
                    <div class="col-sm-12 text-center" style="min-height: 50px;margin-top: 30px;">
                        <span style="color: green;font-size: 28px;font-family: Arial Rounded MT;">Add Knowledgebase</span>
                        <hr style="color:black;border: 1px solid;"/>
                    </div>
                    <div class="col-sm-3" style="min-height: 350px;"></div>
                    <div class="col-sm-6"  style="min-height: 350px;">
                        <form class="form-horizontal" action="admincode/knowledgebasecode.jsp" method="post">
                            <label>Enter Problem ID:</label>
                            <input type="number" class="form-control" name="problemid" required placeholder="Enter Your Problem ID"/>
                            <br/>
                             <label>Enter Problem Text:</label>
                             <textarea class="form-control" name="problemtext" required placeholder="Enter Your Problem text" rows="3" style="resize: none;"></textarea>
                             <br/>
                             <label>Enter Solution Text:</label>
                             <textarea class="form-control" name="solutiontext" required placeholder="Enter Your Solution text" rows="3" style="resize: none;"></textarea>
                             <br/>
