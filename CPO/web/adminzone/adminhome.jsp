      ...
      <ul class="nav navbar-nav navbar-right"style="font-size: 18px;">
        ...
        <li><a href="logout.jsp"><i class="fa fa-tag"></i>Logout</a></li>
                ...
                <div class="col-sm-12 parent">
                    <div class="col-sm-12 text-center text-capitalize" style="min-height: 50px;"><span style="color:green;font-size: 25px;">Add Notification</span></div>
                    <div class="col-sm-3" style="min-height: 250px;"></div>
                    <div class="col-sm-6" style="min-height: 250px;">
                        <form class="form-horizontal" action="admincode/notificationcode.jsp" method="post">
                            
                            <label>Enter Notification:</label>
                            <textarea class="form-control" name="notificationtext"  placeholder="Enter Notification" rows="3"  required style="resize: none;"></textarea>
                            <br/>
                            <label>&nbsp;</label>
                                    ...
                                    <tr>
                                        <td><%=rs.getString("id")%></td>
                                          <td><%=rs.getString("notificationtext")%></td>
                                            ...
                                            <td><a href="admincode/deletenotification.jsp?id=<%=rs.getString("id")%>">Delete </a></td>
